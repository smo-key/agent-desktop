...
//
// The Rust `session_focus(sessionId, cwd)` command does the model call (extract the
// user's messages → ask the local `llama-server` polish model). It's gated entirely on the
