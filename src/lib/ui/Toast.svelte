<script lang="ts">
  // Root-mounted TOAST overlay: renders the live `toast.items` as a bottom-right
  // stack of small self-dismissing cards (e.g. "Build completed" on task success).
...
<style>
  ...
  .toast {
    ...
    border-left: 3px solid var(--nominal-500, #3ccb7f);
