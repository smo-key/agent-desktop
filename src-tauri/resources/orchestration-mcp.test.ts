...
describe('orchestration-mcp pure core', () => {
  ...
  it('exposes the toolkit tools with arg schemas', () => {
    ...
    // No governance tool leaks into the runtime toolkit, and the removed
    // coordinator-era escalation tool stays gone.
