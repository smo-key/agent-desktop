...
out to `git push` / `git pull` in that folder, and SHALL surface the outcome
non-blockingly via a toast — never blocking the UI and never throwing out of the
menu.
