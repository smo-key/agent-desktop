...
- THEN the command returns a short focus title (≤6 words, no surrounding quotes or
  trailing punctuation) produced by the local model
...
- THEN that block is stripped and the returned title is the bare focus title with
  no reasoning text
